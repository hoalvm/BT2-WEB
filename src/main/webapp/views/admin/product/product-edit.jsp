...
<head>
    ...
    <title>Edit Product | JPA Store</title>
...
<c:choose>
    <c:when test="${not empty product.images and (fn:startsWith(storedImageLower, 'http://') or fn:startsWith(storedImageLower, 'https://'))}">
        <c:set var="currentImageUrl" value="${product.images}" />
    </c:when>
    ...
    <c:otherwise>
        <c:set var="currentImageUrl" value="${fallbackImageUrl}" />
    </c:otherwise>
</c:choose>
    ...
    <section class="card form-card">
        <div class="current-image">
            ...
            <img src="${fn:escapeXml(currentImageUrl)}"
                 alt="Current image for ${fn:escapeXml(product.productName)}"
        ...
        <form method="post" action="${updateUrl}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="productName" name="productName" type="text" maxlength="255" required
                       value="${fn:escapeXml(product.productName)}" autofocus>
            </div>
            ...
            <div class="field-row">
                <div class="form-group">
                    ...
                    <input id="price" name="price" type="number" min="0" step="0.01" required
                           value="${fn:escapeXml(product.price)}">
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <small>Leave empty to keep the current image. A selected file takes priority.</small>
            </div>

            <div class="form-group">
                <label for="imagesFile">Replacement image</label>
